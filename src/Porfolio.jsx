import { Flex, Box, Text, Icon, useMediaQuery, VStack, Center } from "@chakra-ui/react";
...
function Service() {
  ...
  return (
    <VStack>     
      <Flex alignSelf="center"  direction={isNotSmallerScreen ? "row" : "column"}
        spacing="200px"
